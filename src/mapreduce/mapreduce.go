...
type MapReduce struct {
	...
	AvailableWorkers *list.List
        newWorkerAvailable      chan string
        AnnounceFinished        chan bool
	nMapScheduled    int
	nMapCompleted    int
	nReduceScheduled int
...
func InitMapReduce(nmap int, nreduce int,
	...
	mr.Workers = make(map[string]*WorkerInfo)
        ...
        mr.newWorkerAvailable = make(chan string)
        mr.AnnounceFinished = make(chan bool)
	mr.nMapScheduled = 0
	mr.nMapCompleted = 0
	mr.nReduceScheduled = 0
	mr.nReduceCompleted = 0
	return mr
}
